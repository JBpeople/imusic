...
- Android distribution: publish a signed ARM64 Release APK from GitHub Actions. Keep the fixed signing keystore out of Git, preserve it for upgrades, and verify every uploaded APK with `apksigner`.
